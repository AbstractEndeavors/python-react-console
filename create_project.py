...
class ReactManager:
    def __init__(self,window_mgr,parent_dir=None):
        ...
        self.window_mgr = window_mgr or AbstractWindowManager()
    ...
    def get_layout(self):
        return [[sg.Text("Create React Project")],
                ...
                [sg.Button("Create", key="CreateProject",enable_events=True), sg.ProgressBar(100, orientation='h', size=(20, 20), key='ProgressBar'),sg.Text('awaiting project',key='-PROGRESS_TEXT-')],
                ...
                [sg.Listbox(values=[], size=(30, 6), key="ProjectList")],
